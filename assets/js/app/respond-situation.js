...
function audioend(){
    clearInterval(prepareInterval);
    startAudioRecordingPrepareTimer(10,initAudioRecording,recordDuration);
}
...
function uploadToServer(recordRTC, callback) {
    ...
    formData.append('testType', 'respond_situation');
...
function toogleTips(invoker){
    if(invoker == 'content'){
        $('.tip-score-guide').html("5 Re-tells all points of the presentation and describes characters, aspects and actions, their relationships, the underlying development, implications and conclusions<br>\
        4 describes all key points of the presentation and their relations, referring to their implications and conclusions<br>\
        3 Deals with most points in the presentation and refers to their implications and conclusions<br>\
        2 Deals with only one key point and refers to an implication or conclusion. Shows basic understanding of several core elements of the presentation<br>\
        1 Describes some basic elements of the presentation but does not make clear their interrelations or implications<br>\
        0 Mentions some disjointed elements of the presentation");
        $('.tip-suggestion').html("This is an easy question to score on content.");
    }

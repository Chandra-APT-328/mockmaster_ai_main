...
function uploadToServer(recordRTC, callback) {
    ...
    formData.append('testType', 'repeat_sentences');
...
function toogleTips(invoker){
    if(invoker == 'content'){
        $('.tip-score-guide').html("3 All words in the response from the prompt in the correct sequence<br>\
        2 At least 50% of words in the response from the prompt in the correct sequence<br>\
        1 Less than 50% of words in the response from the prompt in the correct sequence<br>\
        0 Almost nothing from the prompt in the response");
        $('.tip-suggestion').html("Do not sacrifice your pronunciation or fluency in pursuit of more content. Use our Methods to help you get the maximum scores possible.");
    }

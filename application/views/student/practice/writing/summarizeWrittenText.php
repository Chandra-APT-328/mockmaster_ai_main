            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Summarize Written Text</h2>
                        <span class="paragraph">Read the passage below and summarize it using one sentence. Type your
                            ...
                            presents the key points in the passage.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="swtx"
            action="<?php echo base_url();?>user/swtx/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
                    ...
                    <div class="card">
                        <div class="card-body px-15">
                            <div class="row justify-content-between px-10 align-items-center">
                                <div class="">
                                <p class="mb-35"><?php if(isset($getQuestionData[0]->title) && strlen($getQuestionData[0]->title) > 0){ echo "#".$getQuestionData[0]->id." ".$getQuestionData[0]->title;} ?>
                                    </p>
                                </div>
                                <div class="">
                                    <small class="mb-35 float-right">
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control textareafield" cols="40" id="answerText" rows="12" name="answer" required></textarea>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-6  col-sm-3 col-md-8 answer-toggle-div">
                    ...
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="_form"></span><?php echo '/1'; ?></td>
                                <!-- <td><span class="suggestion"></span></td> -->
                            </tr>
                            <tr>
...
<script src="<?php echo base_url() ?>assets/js/app/swtx.js"></script>
<script>
...
$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/swtx/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/swtx/'.$next_id; ?>';
});
</script>
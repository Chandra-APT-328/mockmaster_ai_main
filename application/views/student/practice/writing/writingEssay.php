            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Write Essay</h2>
                        <span class="paragraph">You will have 20 minutes to plan, write and revise an essay about the
                            topic
                            below. Your response will be judged on how well you develop a position, organize your ideas,
                            present supporting details, and control the elements of standard written English. You should
                            write 200-300 words.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="essays"
            action="<?php echo base_url();?>user/essays/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Linguistic Range <i aria-label="icon: info-circle" tabindex="-1"
                                        class="anticon anticon-info-circle AIScoreCom__InfoIcon-sc-1yzm0aw-0 gXpbBC info"
                                ...
                                <td><span class="linguistic-range"></span><?php echo '/2'; ?></td>
                                <!-- <td><span class="suggestion"></span></td> -->
                            </tr>
                            <tr>
                                <td>Development, structure and coherence <i aria-label="icon: info-circle" tabindex="-1"
                                        class="anticon anticon-info-circle AIScoreCom__InfoIcon-sc-1yzm0aw-0 gXpbBC info"
                                ...
                                <td><span class="structure"></span><?php echo '/2'; ?></td>
                                <!-- <td><span class="suggestion"></span></td> -->
                            </tr>
                            <tr>
...
<script src="<?php echo base_url() ?>assets/js/app/essays.js"></script>
<script>
...
$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/essays/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/essays/'.$next_id; ?>';
});
</script>
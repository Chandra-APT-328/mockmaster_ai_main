            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Answer Short Question</h2>
                        <span class="paragraph">You will hear a question. Please give a simple and short answer. Often
                            just one or a few words is enough.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="answer_questions"
            action="<?php echo base_url();?>user/answer_questions/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
            ...
            <div class="answer-box">
                ...
                <div>
                    ...
                    <div id="transcript">
                        ...
                        <p>Answer: <?php echo strip_tags($getQuestionData[0]->answer); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
const base_url = '<?php echo base_url('user/answer_questions/'); ?>';
...
<!-- Required vendors -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
<script src="<?php echo base_url() ?>assets/js/app/answer-questions.js"></script>

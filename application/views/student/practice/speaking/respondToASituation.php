            ...
            <div class="col-12 col-lg-12">
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Respond to a situation</h2>
                        <span class="paragraph">Listen to and read a description of a situation. 
                            You will have 20 seconds to think about your answer. Then you will hear a beep. 
                            You will have 40 seconds to answer the question. Please answer as completely as you can.</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="respond_situation"
            action="<?php echo base_url();?>user/respond_situation/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-12" id="transcript">
                                    <?php if(isset($getQuestionData[0]->transcript) && strlen($getQuestionData[0]->transcript) > 0){ echo strip_tags($getQuestionData[0]->transcript, '<p>');} ?>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 quebuttons" style="text-align: right;">
    ...
    <div class="panel-section-card card answer-card d-none py-20 px-10 mt-20">
        <div class="card-body">
            <div class="answer-box">
                ...
                <div>
                    <h4>Transcript:</h4>
                    <div id="transcript"><?php echo strip_tags($getQuestionData[0]->transcript, '<p>'); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
const base_url = '<?php echo base_url('user/respond_situation/'); ?>';
...
<!-- Required vendors -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
<script src="<?php echo base_url() ?>assets/js/app/respond-situation.js"></script>

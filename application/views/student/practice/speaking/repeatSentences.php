            ...
            <div class="col-12 col-lg-12">
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Repeat Sentence</h2>
                        <span class="paragraph">You will hear a sentence. Please repeat the sentence exactly as you
                            hear it. You will hear the sentence only once.</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="repeat_sentences"
            action="<?php echo base_url();?>user/repeat_sentences/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
...
<script>
const base_url = '<?php echo base_url('user/repeat_sentences/'); ?>';
...
<!-- Required vendors -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
<script src="<?php echo base_url() ?>assets/js/app/repeat-sentences.js"></script>

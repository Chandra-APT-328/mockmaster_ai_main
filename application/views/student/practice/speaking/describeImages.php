            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Describe Image</h2>
                        <span class="paragraph">Look at the graph below. In 25 seconds, please speak into the
                            microphone and describe in detail what the graph is showing. You will have 40 seconds to
                            give your response.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="describe_images"
            action="<?php echo base_url();?>user/describe_images/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
...
<section class="mt-35 ">
    <div class="panel-section-card card answer-card d-none py-10 px-25 mt-20">
        <div class="card-body">
...
<script>
const base_url = '<?php echo base_url('user/describe_images/'); ?>';
...
<!-- Required vendors -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
<script src="<?php echo base_url() ?>assets/js/app/describe-images.js"></script>

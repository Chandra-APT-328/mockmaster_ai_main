            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Read Aloud</h2>
                        <span class="paragraph">Look at the text below. In 40 seconds, you must read this text aloud as
                            naturally and clearly as possible. You have 40 seconds to read aloud.</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="read_alouds"
            action="<?php echo base_url();?>user/read_alouds/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
                                ...
                                <div class="col-12 recording-container">
                                    ...
                                    <div class="audio-container">
                                        <div><a href="javascript:void(0)" id="record"><i
                                                    ...
                                                    aria-hidden="true"></i><span>Start</span></a>
                                        </div>
                                    </div>
                                </div>
...
<script>
const base_url = '<?php echo base_url('user/read_alouds/'); ?>';
...
<!-- Required vendors -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
<script src="<?php echo base_url() ?>assets/js/app/read-alouds.js"></script>

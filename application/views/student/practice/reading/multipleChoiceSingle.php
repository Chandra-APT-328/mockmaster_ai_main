            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <span class="paragraph">Read the text and answer the multiple-choice question by selecting the correct response. Only one response is correct.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="r_mcs"
            action="<?php echo base_url();?>user/r_mcs/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
...
$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/r_mcs/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/r_mcs/'.$next_id; ?>';
});

window.addEventListener('load', function() {
    document.getElementById("r_mcs").reset();
})

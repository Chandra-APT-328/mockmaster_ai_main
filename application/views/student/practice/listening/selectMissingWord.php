            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Select Missing Word</h2>
                        <span class="paragraph">You will hear a recording about fiction writing. At the end of the
                            recording the lost word or group of words has been replaced by a beep. Select the correct
                            option to complete the recording.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="l_smw"
            action="<?php echo base_url();?>user/l_smw/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
...
window.addEventListener('load', function() {
    document.getElementById("l_smw").reset();
})

$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/l_smw/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/l_smw/'.$next_id; ?>';
});

            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Write From Dictation</h2>
                        <span class="paragraph">You will hear a sentence. Type the sentence in the box below exactly as
                            you hear it.
                            Write as much of the sentence as you can. You will hear the sentence only once.</span>
                        <br>
                    </div>
                </div>
            </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="wfds"
            action="<?php echo base_url();?>user/wfds/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control textareafield" id="answerText" rows="12" name="answer"
                                        required></input>
                                </div>
                            </div>
...
<div class="modal fade" id="tipsModel" role="dialog" tabindex="-2" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6>Score Guide</h6>
                <p>You will get 1 mark for each correctly spelled word.</p><br>
                <h6>Suggestion</h6>
                <p>WFD is a key question in listening. If you need 79, you need to get at least 80% words correct. If
                    you need 65, you need to get at least 70% words correct. If you need 50, you need to get at least
                    50% words correct.</p>
            </div>
            <div class="modal-footer">
...
window.addEventListener('load', function() {
    document.getElementById("wfds").reset();
});

$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/wfds/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/wfds/'.$next_id; ?>';
});

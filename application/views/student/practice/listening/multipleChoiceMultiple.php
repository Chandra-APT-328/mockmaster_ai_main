            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <form class="mb-5" id="l_mcm"
                            action="<?php echo base_url();?>user/l_mcm/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
                            ...
                            <span class="paragraph">Listen to the recording and answer the question by selecting all the
                                correct responses. You will need to select more than one response.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="tipsModel" role="dialog" tabindex="-2" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6>Score Guide</h6>
                <p>You will get 1 mark for each correct choice, and lose 1 mark for each wrong choice. The minimum
                    score of each question is 0.</p><br>
                <h6>Suggestion</h6>
                <p>Most questions have 2 correct answers. But there may be 3 correct answers occasionally. If you
                    are uncertain, just select one answer.</p>
            </div>
            <div class="modal-footer">
...
window.addEventListener('load', function() {
    document.getElementById("l_mcm").reset();
});

$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/l_mcm/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/l_mcm/'.$next_id; ?>';
});

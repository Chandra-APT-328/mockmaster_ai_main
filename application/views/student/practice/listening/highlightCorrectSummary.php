            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <h2 class="section-title mb-3">Highlight Correct Summary</h2>
                        <span class="paragraph">You will hear a recording. Click on the paragraph that best
                            relates to the recording.</span><br>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mt-35">
    <div class="panel-section-card py-20 px-10 mt-20">
        <form class="mb-5" id="l_hcs"
            action="<?php echo base_url();?>user/l_hcs/<?php if(isset($getQuestionData) && strlen($getQuestionData[0]->id) > 0){ echo $getQuestionData[0]->id;} ?>"
...
<script src="<?php echo base_url() ?>assets/js/app/l_hcs.js"></script>
<script>
const answer = <?php echo $getQuestionData[0]->answer; ?>;

window.addEventListener('load', function() {
    document.getElementById("l_hcs").reset();
});

$('#previous').click(function() {
    location.href = '<?php echo base_url().'user/l_hcs/'.$prev_id; ?>';
});

$('#next').click(function() {
    location.href = '<?php echo base_url().'user/l_hcs/'.$next_id; ?>';
});

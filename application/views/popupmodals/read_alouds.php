                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="pronunciation"><?php echo $component_score->pronunciation; ?></span><?php echo '/'.$max_score; ?></td>
                                <?php if($suggestion){ ?>
                                    <td><span class="suggestion"><?php echo $suggestion; ?></span></td>
                                <?php } ?>
                            </tr>
                            <tr>
                                ...
                                <td><span class="fluency"><?php echo $component_score->fluency; ?></span><?php echo '/'.$max_score; ?></td>
                                <?php if($suggestion){ ?>
                                    <td><span class="suggestion"><?php echo $suggestion; ?></span></td>
                                <?php } ?>
                            </tr>

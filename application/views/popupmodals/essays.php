                    ...
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="linguistic-range"><?php echo $component_score->linguistic; ?></span><?php echo '/2'; ?></td>
                                <?php if($suggestion){ ?>
                                    <td><span class="suggestion"><?php echo $suggestion; ?></span></td>
                                <?php } ?>
                            </tr>
                            <tr>
                                <td>Development, structure and coherence 
                                    <!-- <i aria-label="icon: info-circle" tabindex="-1"
                                        class="anticon anticon-info-circle AIScoreCom__InfoIcon-sc-1yzm0aw-0 gXpbBC info"
                                ...
                                <td><span class="structure"><?php echo $component_score->structure; ?></span><?php echo '/2'; ?></td>
                                <?php if($suggestion){ ?>
                                    <td><span class="suggestion"><?php echo $suggestion; ?></span></td>
                                <?php } ?>
                            </tr>
